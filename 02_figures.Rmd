...
figure6 <- plots_cf_rs %>%
  mutate("AGB (Mg/ha)" = log1p(agb_plot_ha),
         #"AGB" = as.numeric(agb_plot_ha),
         #"Basal area" = as.numeric(basal_area_ha),
         "Basal area (m/ha)" = sqrt(basal_area_ha),
         "Lorey's height (m)" = sqrt(loreys_height),
         #"Lorey's height" = as.numeric(loreys_height),
         #"Tree density" = as.numeric(tree_density),
         "Tree density (tree/ha)" = sqrt(tree_density)) %>%
...
ggsave("FIGURE3.png", figure6, width=16, height=12, units="cm", dpi = "print")
```
...
ggsave("FIGURE4.png", figure7, width=18, height=5.5, units="cm", dpi = "print")
